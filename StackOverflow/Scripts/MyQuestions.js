const myQuestionTable = document.querySelector('.myQuestion-table');
let dataSearch = [];

$(document).ready(function() {
    $.ajax({
        type: 'POST',
        url: 'MyQuestions.aspx/MyQuestions',
        dataType: 'json',
        ...
        `<td>
            <div class="card p-2 d-flex flex-row justify-content-start align-items-center">
                ...
                <div class="card-body" style="width: 80%">
                    ...
                    ${dummyDiv.innerHTML}
                    <div class="float-end">
                        by <span class="text-primary">YOU</span> on ${createTime}
                    </div>
                </div>
            </div>
        </td>`
        myQuestionTable.appendChild(div)
    }
}
